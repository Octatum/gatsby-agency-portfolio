    ...
    return (
      ...
      >
        ...
        <section className="page-container work">
          ...
          <section
            className="section-container services medium"
          ...
          <section
            className="section-container medium"
            style={{ display: 'none' }}
          >
            ...
            <div style={styles.clientList}>
              {clientData.map(client => (
                <a
                  key={client.node.title}
                  style={styles.clientItem}
                  href={`https://${client.node.metadata.url}`}
                >
                  <p>{client.node.title}</p>
                  <img
                    src={client.node.metadata.image.url}
